...
class NewListTest(TestCase):
    ...
    def test_display_only_items_for_that_list(self):
        """тест: отображает только элементы данного списка"""
...
class NewItemTest(TestCase):
    """тест добавления нового элемента списка"""
    ...
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        self.client.post(f'/lists/{correct_list.id}/add_item', data={'item_text': 'New item for existing list'})
